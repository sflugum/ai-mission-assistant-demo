...
const focusRingHero =
  'focus-visible:outline-none focus-visible:ring-[3px] focus-visible:ring-accent focus-visible:ring-offset-[3px] focus-visible:ring-offset-white'
...
export function MarketingHeroTagline() {
  return (
    <div className="space-y-1">
      <h2 className="font-heading text-lg font-semibold leading-none tracking-tight text-slate-900">
