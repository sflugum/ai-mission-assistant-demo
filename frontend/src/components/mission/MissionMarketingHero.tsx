...
export const heroBtnPrimaryClass =
  `inline-flex min-h-[44px] min-w-[44px] items-center justify-center rounded-xl bg-primary px-8 py-3 text-base font-bold text-white transition-colors hover:bg-[#3d997c] active:bg-[#368f72] disabled:pointer-events-none disabled:opacity-60 ${focusRingHero}`

export const heroBtnSecondaryClass =
  `inline-flex min-h-[44px] min-w-[44px] items-center justify-center rounded-xl border-2 border-secondary bg-white px-8 py-3 text-base font-bold text-secondary transition-colors hover:bg-secondary/10 active:bg-secondary/15 ${focusRingHero}`
